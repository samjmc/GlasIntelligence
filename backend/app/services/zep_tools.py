...
class InsightForgeResult:
    ...
    Contains retrieval results for multiple sub-queries, plus consolidated analysis.
    """
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            ...
            *(
                ...
                if self.interview_mode == "reconstructed"
                else []
            ),
...
Return a JSON-formatted list of sub-questions in English."""
    ...
    def interview_agents(
        ...
        try:
            ...
            logger.info(
                f"Interview API returned: {api_result.get('interviews_count', 0)} results, success={api_result.get('success')}, mode={result.interview_mode}"
            )
