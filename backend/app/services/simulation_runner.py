...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        max_rounds = min(max_rounds, hard_cap) if max_rounds is not None and max_rounds > 0 else hard_cap
        ...
        try:
            ...
            # Stays open for the subprocess's lifetime; closed in cleanup, so no `with`.
            main_log_file = open(main_log_path, "w", encoding="utf-8")  # noqa: SIM115
