...
def build_graph_task(self, project_id: str, task_id: str, graph_name: str,
    ...
    try:
        ...
        task_manager.update_task(
            task_id, status=TaskStatus.COMPLETED, message="Graph build complete",
        ...
        task_manager.update_task(
            task_id, status=TaskStatus.FAILED, message=f"Build failed: {e}",
            error=str(e),
        )
        raise
