...
def get_graph_data(graph_id: str):
    ...
    try:
        ...
        resp = jsonify({"success": True, "data": graph_data})
        ...
        if stale.outcome == CacheOutcome.STALE and stale.data:
            ...
            resp = jsonify({"success": True, "data": stale.data})
            ...
            return resp
        return jsonify({"success": False, "error": "Failed to retrieve graph data"}), 500
