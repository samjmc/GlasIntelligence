...
This module encapsulates automatic page-turning logic (with per-page retries),
...
def _fetch_page_with_retry(
    ...
    **kwargs: Any,
    ...
    """Single-page request with exponential backoff retry on transient network/IO errors."""
    if max_retries < 1:
