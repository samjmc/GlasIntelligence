...
const renderMarkdown = (content) => {
  ...
  // Clean <p><br> immediately before block elements (from extra blank lines)
  ...
  // Fix non-contiguous ordered list numbering: when single <ol> items are separated by paragraph content, keep numbers incrementing
